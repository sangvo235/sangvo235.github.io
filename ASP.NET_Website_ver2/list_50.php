...
<h1>Students who recieved less than 50% on second attempt!</h1> 
...
// DATABASE CONNECTION //
	...
	if (!$conn) {
		...
		$query = "select sid, fname, lname, score, attempt from $sql_table where score in (0.5,1,1.5,2) and attempt in (2) order by sid";
